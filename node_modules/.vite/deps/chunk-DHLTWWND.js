import {
  ...
  useId_default
} from "./chunk-YWZKBE35.js";
import {
  Transition_default
} from "./chunk-6ZMSK5LF.js";
import {
  HTMLElementType,
...
var Tooltip = React4.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const closeTimer = React4.useRef();
  const enterTimer = React4.useRef();
  const leaveTimer = React4.useRef();
  const touchTimer = React4.useRef();
  ...
  const stopTouchInteraction = React4.useCallback(() => {
  ...
  return (0, import_jsx_runtime4.jsxs)(React4.Fragment, {
    children: [React4.cloneElement(children, childrenProps), (0, import_jsx_runtime3.jsx)(PopperComponent, _extends({
...
//# sourceMappingURL=chunk-DHLTWWND.js.map
